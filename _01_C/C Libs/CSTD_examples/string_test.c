...
static void example_string_search(void)
{
	...
	for (char* token = strtok_s(str, " ", &next_token); 
...
[Basic String Operations]
strcpy_s: Hello
strncpy_s: Hello World!
strcat: Hello World! Welcome
strcmp: 'apple' < 'banana'
...
[String Searching]
Parsing the str: 'The quick brown fox jumps over the lazy dog'
strchr: 'q' found at position 4
strstr: 'fox' found at position 16
memchr: Found 30 at offset 8
The
quick
brown
fox
...
lazy
dog
Contents of the str now: 'The\0quick\0brown\0fox\0jumps\0over\0the\0lazy\0dog\0'
